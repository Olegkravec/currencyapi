...
/**
 * That's copypaste of original SwaggerService with some additional functions.
 * As a required $item as private - I must copy class instead of extend
 *
 *
...
//            $this->saveDescription($concreteRequest, $controller_annotations);
    ...
    private function saveHeaders($request, AnnotationsBagInterface $annotations){
        $this->item['summary'] = $annotations->get('summary');
